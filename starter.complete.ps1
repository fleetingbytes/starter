$starterPythonCommand = "starter.exe"
$starterCommandAlias = "starter"

Function starter {
    Invoke-Expression "$starterPythonCommand $args"
}

$starterArgCompleteScriptBlock = {
	...
	Write-Verbose "Executing Arcomplete"
    Invoke-Expression $starterPythonCommand -OutVariable completionResult -ErrorVariable errorOut -ErrorAction SilentlyContinue | Out-Null
...
Register-ArgumentCompleter -Native -CommandName $starterCommandAlias -ScriptBlock $starterArgCompleteScriptBlock
